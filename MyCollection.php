...
if(isset($_POST['delete'])){
	$DeleteQuery="DELETE FROM mybottles WHERE Id='$_POST[hidden]'";
	mysqli_query($con,$DeleteQuery);
	
}
$sql="SELECT* FROM mybottles";
...
echo "<td>" . "<input type=hidden name=hidden value=" . $record['Id'] .  "</td>"; //hidden field in caz ca schimb valoarea lui Id
